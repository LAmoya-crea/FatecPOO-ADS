 ...
 * @author Fatec
 */
@WebServlet(name = "LucasRandomServlet", urlPatterns = {"/randomservlet.html"})
public class LucasRandomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            int n = 0;
            out.println("<form action=\"randomservlet.html\"  >\n" +
"            Quantidade \n" +
